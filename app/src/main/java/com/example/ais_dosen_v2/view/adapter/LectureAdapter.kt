...
import uinjkt.ac.id.aismobilev2.R
import uinjkt.ac.id.aismobilev2.model.main.model.Lecture
import uinjkt.ac.id.aismobilev2.utils.circularProgressBar
import uinjkt.ac.id.aismobilev2.utils.emptyString
    ...
    inner class LectureViewHolder(itemView: View) : ViewHolder(itemView) {
        fun bindLectureItem(lectureItem: Lecture) {
            with(itemView) {
                ...
                tvLectureName.text = lectureItem.matakuliahnama
